...
Converted from [`evenwins.bas`](../evenwins.bas) with:

```sh
decb-to-b09 -l -O -t --basic09-for-loops evenwins.bas evenwins.b09
```

## `gameofevenwins.b09`

Converted from [`gameofevenwins.bas`](../gameofevenwins.bas) with:

```sh
decb-to-b09 -l -O -t --basic09-for-loops gameofevenwins.bas gameofevenwins.b09
```
