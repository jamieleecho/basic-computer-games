# Rock Scissors Paper in BASIC09
...
Converted from [`rockscissors.bas`](../rockscissors.bas) with:

```sh
decb-to-b09 -l -O -t --basic09-for-loops rockscissors.bas rockscissors.b09
```
