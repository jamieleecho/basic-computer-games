...
Converted from [`craps.bas`](../craps.bas) with:

```sh
decb-to-b09 -l -O -t --basic09-for-loops craps.bas craps.b09
```

## `distributions.b09`

Converted from [`distributions.bas`](../distributions.bas) with:

```sh
decb-to-b09 -l -O -t --basic09-for-loops --no-optimize X distributions.bas distributions.b09
```
