...
Converted from [`hi-lo.bas`](../hi-lo.bas) with:

```sh
decb-to-b09 -l -O -t --basic09-for-loops hi-lo.bas hi_lo.b09
```

The file is named `hi_lo.b09` rather than after `hi-lo.bas` because OS-9 file names cannot contain `-`.
